...
/* SLIDERS */
function initSlider(sliderId, trackId, dotsId, dotClass, interval) {
...
initSlider('heroSlider', 'heroTrack', 'heroDots', 'hero-dot', 6000);
initSlider('visualSlider', 'visualTrack', 'visualDots', 'closing-visual-dot', 5000);
